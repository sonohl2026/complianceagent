    ...
    <div className="rounded border border-slate-200 dark:border-slate-800 p-5 space-y-4 max-w-2xl">
      ...
      {identityFound ? (
        ...
        <div className="rounded border border-amber-300 bg-amber-50 dark:border-amber-700 dark:bg-amber-950 p-3 text-sm">
          No FDA or CMS coverage record turned up under "{stage1.product_name}". Correct the name
          below, or start over with a document/link instead.
        </div>
      )}
      ...
      <div className="flex items-center gap-2">
        ...
        {!editing && (
          ...
          >
            {identityFound ? "Not quite -- correct it" : "Correct the name"}
          </button>
        )}
      </div>
